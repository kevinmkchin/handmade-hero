...
{
    // TODO(Kevin): Need to do something that doesn't use the divide/multiply method
...
ChunkPositionFromTilePosition(world *World, int32 AbsTileX, int32 AbsTileY, int32 AbsTileZ)
{
    ...
    // TODO(Kevin): Think this through on the real stream and actually work out the math.
    if(AbsTileX < 0)
    {
        --Result.ChunkX;
    }
...
{
    // TODO(Kevin): If this moves an entity into the camera bounds, should it automatically
    ...
    else
    {
        if(OldP)
        {
            // NOTE(Kevin): Pull the entity out of its old entity block
        ...
        if(NewP)
        {
            // NOTE(Kevin): Insert the entity into its new entity block
